...
RUN Rscript -e 'install.packages(c("htmltools","attempt","shiny", "shinyjs", "config","leaflet","golem","DT", "echarts4r", "leafdown", "bs4Dash", "shinyFeedback", "shinythemes", "shinycssloaders"))'
